    ...
    <div className="min-h-screen bg-gradient-to-br from-[#fafafa] via-[#f8f6f3] to-[#f5f2ed] text-[#2c2c2c]">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        ...
        <section className="mb-20 text-center">
          ...
          <p className="text-sm text-[#9ca3af]">（Instagram & TikTok 整合即將推出）</p>
        </section>

        {/* Latest Articles */}
        <section className="mb-20">
          <h2 className="text-3xl font-light mb-12 text-center tracking-[0.1em] teaver-heading">最新文章</h2>
        ...
        {/* Categories */}
        <section className="mb-20">
          <h2 className="text-3xl font-light mb-12 text-center tracking-[0.1em] teaver-heading">分類</h2>
